...
namespace ExaDG::Acoustics
{
  ...
  private:
    ...
    set_field_functions() final
    {
      ...
      pml_info.point_on_plane = {450.0, 140.0, -150.0}; // PML right
    ...
    std::string pointwise_output_points_filename = "/home/fs72754/fkraxb02/dealII_exaDG/exadg_apps/applications/acoustic_conservation_laws/valley_sourceRegion_w450/monitoring_points_w450.0.txt";
