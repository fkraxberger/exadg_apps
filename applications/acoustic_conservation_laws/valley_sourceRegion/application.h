...
namespace ExaDG::Acoustics
{
  ...
  private:
    ...
    set_field_functions() final
    {
      ...
      pml_info.point_on_plane = {300.0, 140.0, -10.0}; // PML right
      ...
      pml_info.point_on_plane = {10.0, 250.0, -10.0}; // PML top
    ...
    double pml_thickness = 10.0; // thickness of the PML region
